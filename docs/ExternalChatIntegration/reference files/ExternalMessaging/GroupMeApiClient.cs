...
namespace Cobra.Poc.ExternalMessaging;

/// <summary>
/// Configuration settings for GroupMe API integration.
/// Stored at the organization level to support multi-tenant deployments.
/// </summary>
public class GroupMeSettings
{
    ...
    /// </summary>
    public required string WebhookBaseUrl { get; set; }
}
...
/// 
/// This is a standalone HTTP client with no COBRA-specific dependencies.
...
public class GroupMeApiClient : IGroupMeApiClient
{
    ...
    public async Task<GroupMeGroup> CreateGroupAsync(string name, string? description = null)
    {
        ...
        var request = new
        {
            ...
            share = true  // Enable share URL for easy joining
        };
    ...
    public async Task<GroupMeBot> CreateBotAsync(string groupId, string botName, Guid channelMappingId)
    {
        ...
        var request = new
        {
            bot = new
            {
                ...
                avatar_url = (string?)null  // Could be COBRA logo URL
            }
        };
...
public class GroupMeAttachment
{
    ...
    public string Type { get; set; } = default!;  // "image", "location", etc.
...
public class GroupMeWebhookPayload
{
    ...
    public string SenderType { get; set; } = default!;  // "user" or "bot"
